import { AlertTriangle, ArrowLeft, BarChart3, Coins, ExternalLink, Loader2, ShieldCheck, Users, WalletCards } from "lucide-react";
...
export default function Admin() {
  ...
  const overviewQuery = trpc.admin.overview.useQuery(undefined, { enabled: isAdmin, retry: false });
